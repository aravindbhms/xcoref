...
//  val lastNameMisMatch = pairwisePenalty(lastNames, logorithmic = true)
//  //
//  //penalty features
//  val firstNameMisMatch = pairwisePenalty(firstNames, logorithmic = true)
//  if (lastNames.size > 0) addFeature(lastNameMisMatch, "attr-ln-pwp")
//  if (firstNames.size > 0) addFeature(firstNameMisMatch, "attr-fn-pwp")
//  //
//  //reward features
//  val firstNameScore = pairwiseReward(firstNames, logorithmic = true)
//  val lastNameScore = pairwiseReward(lastNames, logorithmic = true)
//  val titleScore = pairwiseReward(titles, logorithmic = true)
...
//  }
//
//  def pairwisePenalty(vs: IndexedSeq[(String, Double)], logorithmic: Boolean): Double = {
//    var i = 0;
//    var j = 0;
//    var result = 0.0
//    while (i < vs.length) {
...
//      i += 1
//    }
//    if (logorithmic) scala.math.log(result + 1.0) else result
//  }
//
//  def pairwiseReward(vs: IndexedSeq[(String, Double)], logorithmic: Boolean): Double = {
//    var i = 0;
//    var result = 0.0;
//    while (i < vs.length) {
